...
For extension errors: `chrome://extensions` → click red **Errors** button on your extension card.
...
2. Go to **Sources** tab
3. In file tree: look for your extension under **"Content scripts"** section
...
3. Close and reopen any affected tabs (content scripts need page reload)
