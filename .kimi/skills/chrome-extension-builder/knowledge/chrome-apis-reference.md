# Chrome APIs Reference — Working Examples
...
**Never use `localStorage` in extensions** — it's not accessible from service workers and doesn't persist correctly across contexts.
...
**Note**: Minimum period is 1 minute in production (0.5 minute in dev mode with DevTools open).
